...
set modname=sato_additional_equipment_distributor_variants_only
...
xcopy "%~dp0\equipment_distributor_variants\" "%~dp0\tmp_scripts\" /i /e /y
...
REM after build, copy scripts folder to dist\scripts folder.
